...
"""Applies -2.2m Z correction to top_floor and attic, re-renders final stack."""
...
TOP_FLOOR_Z_FIX = -2.2  # metres downward
...
# Apply correction to top_floor and attic (keep relative spacing)
global_T["top_floor"][2, 3] += TOP_FLOOR_Z_FIX
global_T["attic"][2, 3]     += TOP_FLOOR_Z_FIX

print("Updated global Z offsets:")
...
fig.suptitle("Step 4d — Final Global Stack (Z corrected)",
...
out_img = OUT / "04d_final_stack.png"
plt.tight_layout()
...
cache_out = OUT / "04d_final_transforms.pkl"
